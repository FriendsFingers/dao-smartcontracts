...
//
// @param owner an account that has the owner role
...
function shouldBehaveLikePublicRole (owner, authorized, otherAuthorized, [anyone], rolename, manager) {
  ...
  describe('should behave like public role', function () {
    ...
    describe('remove', function () {
      ...
      const from = owner || anyone;

      context(`from ${owner ? 'owner' : 'any'} account`, function () {
